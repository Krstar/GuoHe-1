...
public class UrlUtil {
    ...
    public static final String HOT_BOOK = "http://120.25.88.41/vpnHotBook";       //查询热搜图书

    public static final String BOOK_LIST = "http://120.25.88.41/vpnBookList";     //查询图书清单

    public static final String BOOK_DETAIL = "http://120.25.88.41/vpnBookDetail"; //查询图书详情
    ...
    public static final String EMS = "http://m.kuaidi100.com/";       //查快递
