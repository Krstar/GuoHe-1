...
public class JobActivity extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置和toolbar相关的
        Toolbar toolbar = (Toolbar) findViewById(R.id.ao_lan_toolbar);
        ...
        webView = (WebView) findViewById(R.id.ao_lan_web_view);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.getSettings().setCacheMode(WebSettings.LOAD_DEFAULT);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl(url);

        mWaveSwipeRefreshLayout = (WaveSwipeRefreshLayout) findViewById(R.id.ao_lan_swipe);
        //设置转的圈的颜色
